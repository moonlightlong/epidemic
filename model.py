...
graph = nx.generators.random_graphs.barabasi_albert_graph(20, 4)
    ...
    def spread(self, seed=None, flags=False):
        ...
        if not flags:
            ...
            while(number):
                ...
                infected_distance += self.spread_one_time(infected, seed=seed)
                number -= 1
                self.__n += 1
            print("")
            return infected_distance / float(self.n)
        else:
            pass